...
export default function About() {
  return (
    <section className="bg-crema px-4 py-16 sm:py-20">
      <title>Pizza Menu | Straight Outta Naples, Maidstone</title>
      <meta name="description" content="Antipasti, arancini, and authentic Neapolitan pizza — see the full menu at Straight Outta Naples, Maidstone." />
